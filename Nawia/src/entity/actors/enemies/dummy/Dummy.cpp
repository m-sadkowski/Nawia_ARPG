...
namespace Nawia::Entity {
		...
		: _stay_timer(0.0f), _fireball_cooldown_timer(0.0f)
	{
		...
		loadModel("assets/models/actors/dummy/dummy_idle.glb");
		
		addAnimation("walk", "assets/models/actors/dummy/dummy_walk.glb");
		addAnimation("cast_fireball", "assets/models/actors/dummy/dummy_cast_fireball.glb");
		addAnimation("death", "assets/models/actors/dummy/dummy_death.glb");
