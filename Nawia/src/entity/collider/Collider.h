...
namespace Nawia::Entity {
    ...
    class Collider {
    public:
        Collider(Entity* owner, float offset_x = 0.0f, float offset_y = 0.0f) : _owner(owner), _offset(Vector2{offset_x, offset_y}) {}
    ...
    public:
        CircleCollider(Entity* owner, const float radius, float offset_x = 0.0f, float offset_y = 0.0f) 
    ...
    public:
        RectangleCollider(Entity* owner, const float width, const float height, float offset_x = 0.0f, float offset_y = 0.0f) 
    ...
    public:
        ConeCollider(Entity* owner, const float radius, const float angle, float offset_x = 0.0f, float offset_y = 0.0f) 
